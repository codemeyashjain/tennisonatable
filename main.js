...
function startGame()
{
  game_status="start"; //Set the value of the status variable created in step 1 to “start”.//Update the h3 tag which we have created inside index.html file in project 138 who has id “status” to "Game Is Loaded”.
